        ...
        listView.setCellFactory(param -> new ListCell<String>() {
            ...
            public void updateItem(String name, boolean empty) {
                ...
                if (empty) {
                    ...
                    if(name.equals(" "))
                    ...
                    else if(name.equals("Can you go again? My money is on yes!"))
                    ...
                    else if(name.equals("Do not lose sight of the dumbbells. If they are leaving your sight you are extending too far!"))
                        ...
                        imageView.setImage(listOfImages[8]);
                    else if(name.equals("Do not let your feet rest on the floor until all reps are complete."))
                        imageView.setImage(listOfImages[8]);
                    setText(name);
